...
REFS = {
    ...
    "tryptone": "Tryptone = pancreatic (tryptic) digest of casein; tryptophan retained. QUANTITATIVE amino-acid composition (mg/g) from casein: Glu/Pro/Leu-dominant. Source: FAO Amino-acid Content of Foods (1970); Rafiq S et al., Asian-Australas J Anim Sci 2016;29:1022, doi:10.5713/ajas.15.0452; BD Bionutrient Technical Manual.",
    "casein_peptone": "Casein peptone = enzymatic digest of casein. QUANTITATIVE amino-acid composition (mg/g): Glu/Pro/Leu-dominant. Source: FAO (1970); Rafiq S et al., Asian-Australas J Anim Sci 2016;29:1022, doi:10.5713/ajas.15.0452; BD Bionutrient Technical Manual.",
    "trypticase": "Trypticase = pancreatic digest of casein (BBL). QUANTITATIVE casein amino-acid composition (mg/g): Glu/Pro/Leu-dominant. Source: Rafiq S et al., Asian-Australas J Anim Sci 2016;29:1022, doi:10.5713/ajas.15.0452; BD Bionutrient Technical Manual.",
    "peptone": "Peptone = enzymatic digest of animal protein/gelatin. QUANTITATIVE amino-acid composition (mg/g). Source: gelatin/collagen signature: glycine/proline-dominant, tryptophan/cysteine near-zero (intrinsic to collagen). BD Bionutrient Technical Manual; GRiSP bacteriological peptone data sheet.",
    "proteose_peptone": "Proteose peptone = enzymatic protein digest. QUANTITATIVE amino-acid composition (mg/g), gelatin/animal signature (glycine/proline-dominant). Source: BD Bionutrient Technical Manual.",
    "soytone": "Soytone = papaic digest of soybean meal. QUANTITATIVE amino-acid composition (mg/g): glutamate/aspartate-rich soy-protein profile. Source: BD/US Biological Soytone data sheet; soy protein amino-acid literature.",
    "casamino_acids": "Casamino acids = ACID hydrolysate of casein. Source: tryptophan destroyed, cysteine very low. QUANTITATIVE casein amino-acid composition (mg/g, Trp=0): Glu/Pro/Leu-dominant. Source: Rafiq S et al. 2016, doi:10.5713/ajas.15.0452; BD/Difco Casamino Acids table.",
    "beef_extract": "Beef extract = aqueous meat extract. QUANTITATIVE composition (mg/g): muscle-protein amino acids (Glu/Leu-rich), creatine, K/Na. Source: BBL Beef Extract analysis (BD Bionutrient Technical Manual); Jarboe JK, Mabrouk AF, J Agric Food Chem 1974;22:787, doi:10.1021/jf60195a038.",
    "meat_extract": "Meat extract (Lab-Lemco) = aqueous meat extract. QUANTITATIVE composition (mg/g): muscle-protein amino acids, creatine, K/Na. Source: BD Bionutrient Technical Manual; Jarboe & Mabrouk, J Agric Food Chem 1974, doi:10.1021/jf60195a038.",
    "lab_lemco": "Lab-Lemco meat extract. QUANTITATIVE composition (mg/g): muscle amino acids, creatine, K/Na. Source: Jarboe & Mabrouk 1974, doi:10.1021/jf60195a038; Oxoid/BD technical data.",
    "malt_extract": "Malt extract = carbohydrate-dominant (~90% sugars). QUANTITATIVE composition (mg/g): maltose (~52%) > glucose > maltotriose (Cote GL 1999; BD Bionutrient Technical Manual); minor proline-dominant free amino acids from wort. Source: Fermentation 2018;4:23, doi:10.3390/fermentation4020023.",
}
