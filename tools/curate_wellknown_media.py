...
REF_M9 = ("M9 minimal medium. Source: Sambrook J, Russell DW, Molecular Cloning: A Laboratory Manual, 3rd ed. "
          "CSHL Press 2001. Salts: Na2HPO4, KH2PO4, NaCl, NH4Cl; + 2 mM MgSO4, 0.1 mM CaCl2, ~0.2-0.4% carbon source (glucose).")
REF_TSB = ("Tryptic Soy Broth (Soybean-Casein Digest Medium). Source: BD Bionutrient Technical Manual; USP <62>. "
           "Casein peptone 17, soy peptone 3, NaCl 5, K2HPO4 2.5, dextrose 2.5 g/L.")
REF_BHI = ("Brain Heart Infusion. Source: Rosenow EC, J Dent Res 1919; BD BHI formulation: brain/heart infusion solids, "
           "proteose peptone 10, NaCl 5, Na2HPO4 2.5, dextrose 2 g/L.")
REF_NB = ("Nutrient Broth. Source: Atlas RM, Handbook of Microbiological Media (CRC Press). Peptone 5 g + meat/beef extract 3 g "
          "+ NaCl 5 g/L; no added sugar (carbon from the digest).")
REF_TB = ("Terrific Broth. Source: Tartof KD, Hobbs CA, Bethesda Res Lab Focus 1987;9:12; Sambrook & Russell 2001. "
          "Tryptone 12, yeast extract 24 g/L, 0.4% glycerol, potassium phosphate buffer (KH2PO4 0.017 M, K2HPO4 0.072 M).")
REF_YT = ("2xYT. Source: Sambrook & Russell, Molecular Cloning 2001; Miller 1972. Tryptone 16, yeast extract 10, NaCl 5 g/L; no added sugar.")
REF_SOB = ("SOB/SOC. Source: Hanahan D, J Mol Biol 1983;166(4):557-580. SOB: tryptone 20, yeast extract 5, NaCl 0.5 g/L, "
           "2.5 mM KCl, 10 mM MgCl2, 10 mM MgSO4; SOC = SOB + 20 mM glucose.")
REF_MOPS = ("MOPS minimal medium. Source: Neidhardt FC, Bloch PL, Smith DF, J Bacteriol 1974;119(3):736-747. "
...
REF_7H9 = ("Middlebrook 7H9 broth. Source: Middlebrook G, Cohn ML, Am J Public Health 1958; BD Middlebrook 7H9 "
...
REF_MH = ("Mueller-Hinton. Source: Mueller JH, Hinton J, Proc Soc Exp Biol Med 1941;48:330-333. Beef extract + acid "
          "hydrolysate of casein + soluble starch; the CLSI reference medium for antimicrobial susceptibility testing.")
REF_BG11 = ("BG-11. Source: Rippka R et al., J Gen Microbiol 1979;111:1-61; Stanier RY et al. 1971. Photoautotrophic "
...
REF_YPD = "YPD/YEPD. Source: Sherman F, Methods Enzymol 2002;350:3-41. Yeast extract 10, peptone 20, dextrose 20 g/L. S. cerevisiae."
REF_SAB = "Sabouraud dextrose. Source: Sabouraud R 1892; BD formulation. Peptone 10 g/L, dextrose 40 g/L, pH ~5.6. Fungi/yeasts."
REF_MAR = ("Marine Broth 2216. Source: ZoBell CE, J Mar Res 1941;4:42-75; BD Difco. Peptone 5, yeast extract 1, ferric citrate 0.1 g/L "
           "+ full sea-salt ion complement (NaCl, MgCl2, Na2SO4, CaCl2, KCl, NaHCO3 ...).")
REF_RCM = ("Reinforced Clostridial Medium. Source: Hirsch A, Grinsted E, J Dairy Res 1954;21:101-110; Oxoid CM0149. "
           "Peptone, beef & yeast extract, glucose, soluble starch, NaCl, Na-acetate, L-cysteine-HCl (reductant). Anaerobes.")
REF_R2A = ("R2A. Source: Reasoner DJ, Geldreich EE, Appl Environ Microbiol 1985;49:1-7. Low-nutrient medium (yeast extract, "
           "proteose peptone, casamino acids, dextrose, starch, Na-pyruvate, K2HPO4, MgSO4, each ~0.5 g/L) for oligotrophic water bacteria.")
REF_M63 = "M63 minimal. Source: Miller JH, Experiments in Molecular Genetics, CSHL 1972. KH2PO4, (NH4)2SO4, MgSO4, FeSO4, thiamine + carbon source."
REF_DAVIS = "Davis minimal. Source: Davis BD, Mingioli ES, J Bacteriol 1950;60:17-28. K2HPO4/KH2PO4, (NH4)2SO4, Na-citrate, MgSO4 + glucose."
